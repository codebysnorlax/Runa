    ...
    return (
        <div className="max-w-2xl mx-auto px-4 sm:px-6 pb-24 lg:pb-6">
            ...
            <div className="mt-4 flex items-center justify-center text-gray-500 text-[11px] font-medium animate-fade-in" style={{ animationDelay: '0.8s' }}>
                <span className="text-center">Your running data is stored at <a className="text-brand-orange" href="https://convex.dev">convex db</a> 100% Secure.<br />don't worry, we are soon automating this field</span>
            </div>
        </div>
    );
};
