                    ...
                    <div className="space-y-6 animate-fade-in">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
                                <div className="lg:col-span-2">
                                    <h3 className="text-base sm:text-lg font-medium text-white mb-2">Ravi Ranjan Sharma</h3>
                                    <p className="text-gray-300 text-sm leading-relaxed mb-4">
                                        Tech enthusiast who loves building innovative projects and crafting problem-solving software with the latest technologies. Passionate about creating user-friendly applications that make a difference in people's lives.
                                    </p>
                                    <div className="space-y-2">
                                ...
                                <div className="mt-4 lg:mt-0">
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-1 gap-2 sm:gap-3">
                                        <a href="https://github.com/codebysnorlax" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 text-gray-300 hover:text-brand-orange transition-colors">
                                            <Github className="w-4 h-4 sm:w-5 sm:h-5" />
                                            <span className="text-xs sm:text-sm">GitHub</span>
                                        </a>
                                        <a href="mailto:rr2436310@gmail.com" className="flex items-center space-x-2 text-gray-300 hover:text-brand-orange transition-colors">
                                        ...
                                        <a href="https://instagram.com/nr_snorlax" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 text-gray-300 hover:text-brand-orange transition-colors">
                                            <Instagram className="w-4 h-4 sm:w-5 sm:h-5" />
                                            <span className="text-xs sm:text-sm">Instagram</span>
                                        </a>
                                        <a href="https://twitter.com/codebysnorlax" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 text-gray-300 hover:text-brand-orange transition-colors">
                                            <Twitter className="w-4 h-4 sm:w-5 sm:h-5" />
                                            <span className="text-xs sm:text-sm">Twitter</span>
                                        </a>
                                        <a href="https://linkedin.com/in/ravi-ranjan-9b338b333" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 text-gray-300 hover:text-brand-orange transition-colors">
                        ...
                        <div className="bg-gray-800 p-4 rounded-lg space-y-4">
                            <div className="flex items-center space-x-3">
                                ...
                                <h2 className="text-lg sm:text-xl font-semibold text-white">AI Fitness Tracker</h2>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                                ...
                                <div className="mt-4 md:mt-0">
                                    <h3 className="text-base sm:text-lg font-medium text-white mb-2">Key Features</h3>
                                    <ul className="text-gray-300 text-sm space-y-1">
                        ...
                        <div className="bg-gray-800 p-4 rounded-lg space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                                <div>
                                    <h3 className="text-base sm:text-lg font-medium text-white mb-2">Getting Started</h3>
                                    <ol className="text-gray-300 text-sm space-y-2 list-decimal list-inside">
                                        ...
                                        <li>Define your fitness goals (weekly distance, running days)</li>
                                        <li>Start adding your running sessions</li>
                                    </ol>
                                </div>
                                <div className="mt-4 md:mt-0">
                                    <h3 className="text-base sm:text-lg font-medium text-white mb-2">Daily Usage</h3>
                                    <ol className="text-gray-300 text-sm space-y-2 list-decimal list-inside">
                        ...
                        <div className="bg-gray-800 p-4 rounded-lg">
                            ...
                            <div className="text-gray-300 text-sm space-y-2">
                                <p>• All your data is stored locally in your browser - no external servers</p>
