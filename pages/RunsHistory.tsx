...
import { ArrowUp, ArrowDown, Minus, Edit, Trash2, Search, Filter, ChevronLeft, ChevronRight } from 'lucide-react';
        ...
        <div className="space-y-6">
            ...
            <div className="hidden lg:block">
                <Card>
                    ...
                    {filteredAndSortedRuns.length === 0 && <p className="text-center p-8 text-gray-400">{runs.length === 0 ? 'No runs found. Go for a run!' : 'No runs match your search criteria.'}</p>}
                </Card>
            </div>
                                        ...
                                        <tr key={run.id}>
                                            ...
                                            <td className="px-2 py-3">
                                                <div className="flex items-center justify-center space-x-2">
                                                    <button onClick={() => navigate(`/edit-run/${run.id}`)} className="p-1.5 bg-blue-600 hover:bg-blue-700 rounded transition-colors">
