...
import { Github, Mail, Globe, Instagram, Twitter, Linkedin, User, Code, Target, Shield } from 'lucide-react';
        ...
        <Card>
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-lg font-medium text-white mb-2">Purpose</h3>
                <p className="text-gray-300 text-sm leading-relaxed">
                  A modern, AI-powered fitness tracker designed to monitor your
                  running progress, set personalized goals, and provide
                  intelligent insights into your performance. Built with React
                  and TypeScript for a seamless user experience.
                </p>
              </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="md:col-span-2">
                ...
                <p className="text-gray-300 text-sm leading-relaxed mb-4">
                  ...
                  crafting problem-solving software with the latest
                  technologies. Passionate about creating user-friendly
                  applications that make a difference in people's lives.
                </p>

                <div className="space-y-2">
                  <h4 className="text-white font-medium">Specializations:</h4>
                  <ul className="text-gray-300 text-sm space-y-1">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <a
                    ...
                    className="flex items-center space-x-3 text-gray-300 hover:text-brand-orange transition-colors"
                  >
